...
function homeView() {
  ...
  app.innerHTML = `<div class="shell home">
    <section>
      ...
      <p class="home-copy">One player knows <strong>where the target is</strong>. Their team only gets a clue. Find the hidden middle — before the other team reads you perfectly.</p>
